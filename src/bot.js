...
bot.on("message", (message) => {
  ...
  if (command === "wotd") {
      ...
      .then(function (response) {
        ...
        if (typeof data !== "object") {
          const result = new Discord.MessageEmbed()
            .setTitle(
              `Invalid word: The word you have entered isnt in the dictionary.`
            )
            .setColor(0xff0000);
    ...
    const tt  = "!def <word>\n'Retrieve the *definition(s)* for a given word'\n\n!wotd\n'Retrieve's Merriam Websters *Word of the Day*.'\n\n!dhelp\n'Retrieve a *list of commands* for the dictionary bot.'"
    return channel.send(tt);
  }
});
